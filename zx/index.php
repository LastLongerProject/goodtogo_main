    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top"><div id="navbar-logo"><img src="img/header_logo_zx.png"></div></a>
            </div>
                ...
                <ul class="nav navbar-nav navbar-externallink">
                    ...
                    <li>
                        <a href="http://goodtogo.com.tw">
                            ...
                            <!--
                            <img src="img/goodtogo-logo-72x20.svg" alt="好盒器首頁">
                        -->
                        </a>
                    </li>
                    <li>
   ...
   <!-- Map Section -->
    ...
    <section id="result" class="result-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                   <!-- <div id="result-title" class="valign-parent"><span class="valign-child"><span class="highlight">因為有你</span></span></div> -->
                    <div id="result-title">
                    ...
                    <!-- 第一波: 181; 第二波: 495; (6/13 v2): 83, 6個未歸還;-->
                 </div> 
