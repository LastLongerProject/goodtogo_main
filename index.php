...
<head>
    ...
    <meta name="copyright" content="© 2018 Last Longer Project. All rights reserved." />
    ...
    <meta name="url" content="http://goodtogo.tw">
    ...
    <meta property="og:image" content="http://goodtogo.tw/assets/img/og_img.jpg" />
    <meta property="og:site_name" content="好 盒 器 | 用玻璃杯取代免洗杯" />
    <meta property="og:url" content="http://goodtogo.tw" />
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a class="page-scroll" href="#where">合作店舖</a>
                    </li>
                </ul>
                <ul class="nav navbar-nav navbar-externallink">
                    ...
                    <li>
                        <a target="_blank" href="https://www.facebook.com/good.to.go.tw">
                            <div>
                                <img src="data:image/svg+xml;base64," alt="Facebook粉專">
                            </div>
                        </a>
                    </li>
                </ul>
    ...
    <!-- Intro Section -->
    <section id="intro" class="intro-section scrollify">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div>
    ...
    <!-- How-to Section -->
    <section id="how-to" class="how-to-section scrollify">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <span id="how-to-title">如何使用</span>
                    <div id="how-to-use-img-ctn">
                        <div id="how-to-use-img"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Map Section -->
    <section id="where" class="where-section scrollify">
        <div class="container-fluid">
            <div class="row">
                <div id="map-title" class="valign-parent"><span class="valign-child">合作店舖<span class="highlight">在哪兒</span>？</span>
                </div>
                <div class="col-lg-8">
                    <div id="map"></div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-lg-4">
                    <span class="footer-section-list-title">使用注意事項</span>
                    <ul>
                        <li>請避免撞擊，若有損壞，歸還時請主動告知店員。</li>
                        <li>請注意各店鋪營業時間，以避免撲空。</li>
                        <li>租借服務已投保產品責任險，請安心使用。</li>
                    </ul>
                </div>
                <div class="col-sm-12">
                    <div id="copyright">
